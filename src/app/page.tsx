          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-8 relative">
            <div className="mx-auto max-w-5xl space-y-12">
              ...
              <div className="grid gap-8 md:grid-cols-3">
                ...
                <div className="flex flex-col rounded-xl border border-border bg-card p-8 shadow-md transition-all hover:shadow-lg hover:border-primary/20 group">
                  ...
                  <ul className="mt-6 space-y-4 text-sm flex-1">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>3 Datasets per space</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 rounded-full bg-primary/10 flex items-center justify-center">
                        <svg
                ...
                {/* Pro Plan */}
                <div className="flex flex-col rounded-xl border-2 border-primary bg-card p-8 shadow-xl relative scale-105 z-10">
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground px-4 py-1 rounded-full text-xs font-semibold">
                    MOST POPULAR
                  </div>
                  <div className="space-y-2">
                  ...
                  <ul className="mt-6 space-y-4 text-sm flex-1">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>7 Datasets per space</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center">
                        <svg
                ...
                <div className="flex flex-col rounded-xl border border-border bg-card p-8 shadow-md transition-all hover:shadow-lg hover:border-primary/20 group">
                  ...
                  <div className="mt-6 flex items-baseline">
                    <span className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/80">Custom</span>
                  </div>
                  <div className="mt-2 mb-6 h-0.5 w-16 bg-gradient-to-r from-primary/30 to-transparent rounded-full"></div>
                  <ul className="mt-6 space-y-4 text-sm flex-1">
                    <li className="flex items-center">
                      ...
                      <span>Unlimited dataspaces</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 rounded-full bg-primary/10 flex items-center justify-center">
                        <svg
                    ...
                    <li className="flex items-center">
                      ...
                      <span>All generation methods</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 rounded-full bg-primary/10 flex items-center justify-center">
                        <svg
